...
class RegistroComitePage extends StatefulWidget {
  String idEscuela;
  RegistroComitePage({super.key, required this.idEscuela});

  @override
  _RegistroComitePageState createState() =>
      _RegistroComitePageState(idEscuela: idEscuela);
}
...
class _RegistroComitePageState extends State<RegistroComitePage> {
  ...
  String idEscuela;
  _RegistroComitePageState({required this.idEscuela});
