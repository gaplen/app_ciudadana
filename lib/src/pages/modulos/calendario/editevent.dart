...
//   @override
//   Widget build(BuildContext context) {
//     // final date = DateTime.fromMillisecondsSinceEpoch(widget.data!['hora']);
//     final date = widget.data != null
//         ? DateTime.fromMillisecondsSinceEpoch(widget.data!['hora'])
//         : DateTime.now();
...
//                     ),
//                     // Text(
//                     //   'Hora: ${dateFormat.format(date) != null ? dateFormat.format(date) : dateFormat.format(_selectedDate)}',
//                     //   style: const TextStyle(
//                     //     fontWeight: FontWeight.w700,
//                     //     fontSize: 17,
//                     //   ),
...
//                     {
//                       // 'puesto': _puestoController.text,
//                       'hora': Timestamp.fromDate(_selectedTime),
//                       'date': Timestamp.fromDate(_selectedDate),
//                       'title': _titleController.text,
...
//           .doc(_auth.currentUser!.uid)
//           .collection('events')
//           .where('hora', isEqualTo: _selectedTime)
//           .where('hora', isGreaterThanOrEqualTo: _selectedTime)
//           .get();
//       // Realizar las operaciones que necesites con la consulta de Firestore
//     }
//   }
