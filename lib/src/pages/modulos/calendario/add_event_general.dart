...
class AddEventGeneral extends StatefulWidget {
  ...
  @override
  State<AddEventGeneral> createState() => _AddEventGeneralState();
}

class _AddEventGeneralState extends State<AddEventGeneral> {
